export const greetings = {
  ...
  description:
    "I'm passionate Full Stack and Machine Learning Engineer having an experience of web applications with Python, Django, React.js, Next.js, GraphQL and cloud services including AWS, Azure and GCP.",
  resumeLink:
    'https://docs.google.com/document/d/1kPWqw0cAozxxtKi0btLYAl3Gs3uo5--lXwyarCpQBwc/edit?usp=sharing',
};

export const openSource = {
  githubUserName: 'rlmathguru',
};
...
export const socialLinks = {
  url: '#',
  linkedin: 'https://www.linkedin.com/in/christopher-martin-840ba3259/',
  github: 'https://github.com/rlmathguru',
  instagram: '#',
  facebook: '#',
  twitter: '#',
};
...
export const educationInfo = [
  {
    ...
    grade: 'Grade A',
    descBullets: [
      'Was an International Collegiate Programming Contest Challenger, and completed tens of local contests.',
      'Solved hundreds of difficult algorithms and data structure problems.',
    ],
  },
];
